...
export default function App() {
  const [activeView, setActiveView] = useState<'map' | 'tour' | 'radar' | 'museum' | 'trail'>('map');
  ...
  return <div className="dharohar-app">
    ...
    <main id="main-content"><Suspense fallback={<div className="page-loading" role="status">Opening your next discovery…</div>}>
